...
A valid plus is defined here as the crossing of two segments (horizontal and vertical) of equal lengths. These lengths must be odd, and the middle cell 
...
The NN subsequent lines contains MM characters, where each character is either G (goodgood) or B (badbad). If the ythyth character in the xthxth line is G, 
then (x,y)(x,y) is a goodgood cell (otherwise it's a badbad cell).
